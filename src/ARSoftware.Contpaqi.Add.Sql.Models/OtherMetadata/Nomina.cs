...
public partial class Nomina
{
    ...
    public virtual ICollection<EntidadSCNF> EntidadSCNF { get; set; } = new List<EntidadSCNF>();

    public virtual Comprobante GuidDocumentNavigation { get; set; } = null!;

    public virtual ICollection<Nomina_Detalle> Nomina_Detalle { get; set; } = new List<Nomina_Detalle>();

    public virtual ICollection<Nomina_HorasExtras> Nomina_HorasExtras { get; set; } = new List<Nomina_HorasExtras>();

    public virtual ICollection<Nomina_Incapacidad> Nomina_Incapacidad { get; set; } = new List<Nomina_Incapacidad>();

    public virtual ICollection<Nomina_Subcontratacion> Nomina_Subcontratacion { get; set; } = new List<Nomina_Subcontratacion>();
}
