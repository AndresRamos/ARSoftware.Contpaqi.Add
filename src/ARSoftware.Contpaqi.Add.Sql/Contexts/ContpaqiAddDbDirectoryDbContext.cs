...
public partial class ContpaqiAddDbDirectoryDbContext : DbContext
{
    ...
    public virtual DbSet<Cat_MetaType> Cat_MetaType { get; set; }
    ...
    public virtual DbSet<DocumentosDuplicados> DocumentosDuplicados { get; set; }

    public virtual DbSet<EFOS> EFOS { get; set; }

    public virtual DbSet<EFOS_Version> EFOS_Version { get; set; }

    public virtual DbSet<MergeDocs> MergeDocs { get; set; }

    public virtual DbSet<MergeProcess> MergeProcess { get; set; }

    public virtual DbSet<Owners> Owners { get; set; }

    public virtual DbSet<ProcessControl> ProcessControl { get; set; }

    public virtual DbSet<Schema_CompaniesProgObj> Schema_CompaniesProgObj { get; set; }

    public virtual DbSet<Schema_CompaniesProgObj_Temp> Schema_CompaniesProgObj_Temp { get; set; }

    public virtual DbSet<Schema_T_Control> Schema_T_Control { get; set; }

    public virtual DbSet<Schema_T_CurrentObjectIns> Schema_T_CurrentObjectIns { get; set; }
    ...
    public virtual DbSet<Schema_T_DB_Objects> Schema_T_DB_Objects { get; set; }

    public virtual DbSet<Schema_T_DB_Templates> Schema_T_DB_Templates { get; set; }

    public virtual DbSet<Schema_T_DB_TypeSpec> Schema_T_DB_TypeSpec { get; set; }
    ...
    public virtual DbSet<TempCountDocs> TempCountDocs { get; set; }

    public virtual DbSet<TempDestinationDBDetail> TempDestinationDBDetail { get; set; }

    public virtual DbSet<TempDestinationDBTables> TempDestinationDBTables { get; set; }

    public virtual DbSet<TempSourceDBDetail> TempSourceDBDetail { get; set; }

    public virtual DbSet<TempSysFK> TempSysFK { get; set; }

    public virtual DbSet<TempSysObj> TempSysObj { get; set; }

    public virtual DbSet<TunningIdxTmp> TunningIdxTmp { get; set; }

    public virtual DbSet<Tunning_ErroLog> Tunning_ErroLog { get; set; }

    public virtual DbSet<Tunning_InitialParameters> Tunning_InitialParameters { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EFOS>(entity =>
        {
            ...
            entity.HasIndex(e => e.No, "IXC_EFOS").IsClustered();
        ...
        modelBuilder.Entity<MergeProcess>(entity =>
        {
            ...
            entity.HasIndex(e => e.GuidProcess_Merge, "IXC_MergeProcess").IsClustered();
        ...
        modelBuilder.Entity<Owners>(entity =>
        {
            ...
            entity.HasOne(d => d.GuidCompanyNavigation).WithMany()
        ...
        modelBuilder.Entity<ProcessControl>(entity =>
        {
            ...
            entity.HasIndex(e => e.GuidControl, "IXFK_ProcessControl").IsClustered();
            ...
            entity.HasOne(d => d.Id_ProcessNavigation).WithMany()
