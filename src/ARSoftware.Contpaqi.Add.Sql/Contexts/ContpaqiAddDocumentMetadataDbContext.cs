...
using ARSoftware.Contpaqi.Add.Sql.Models.DocumentMetadata;

namespace ARSoftware.Contpaqi.Add.Sql.Contexts
{
    public partial class ContpaqiAddDocumentMetadataDbContext : DbContext
    {
        public ContpaqiAddDocumentMetadataDbContext()
        {
        }

        public ContpaqiAddDocumentMetadataDbContext(DbContextOptions<ContpaqiAddDocumentMetadataDbContext> options)
            : base(options)
        {
        }
